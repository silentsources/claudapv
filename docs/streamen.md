# Content creëren op Azure

## Introductie

Dit document is opgesteld om wat duidelijkheid te bieden wat betreft het creëren van content op Azure. Het is uiteraard toegestaan om content te creëren op Azure, echter zijn hier wel regels aan verbonden. Deze regels gelden voor elke speler die content wilt creëren en niet enkel voor de content creators zoals aangewezen in de Azure discord.
...
3. Je bent als content creator een visite kaartje voor Azure. Mochten er dingen gebeuren, laat het ons weten.
...
7. De naam Azure moet in de titel van de video's of livestreams staan zodat het ook door ons gevonden kan worden.
